     ...
     <div class="card" style="width: 18rem;">
      <div class="row">
        ...
        <div class="card-body">
            ...
            <a href="beli_produk.php?id_produk=<?php echo $row['id_produk']?> "class="btn btn-primary"><i class="fa-solid fa-cart-plus"></i> Add</a>
            <a href="cekout.php?id_produk=<?php echo $row['id_produk']?> "class="btn btn-warning">Check Out</a>
        </div>
      </div>
    </div>  
      <!-- <div class="card">
